...
public class VideoTrimmerUtil {
    ...
    public static final int VIDEO_MAX_TIME = 8;// 8秒
    ...
    public static final int RECYCLER_VIEW_PADDING = ConvertUtils.dp2px(35);
    ...
    private static final int THUMB_HEIGHT = ConvertUtils.dp2px(50);
...
//    }
    ...
    public interface SingleCallback {
        void onSingleCallback(Bitmap bitmap, int interval);
    }
    ...
    public static void shootVideoThumbInBackground(final Context context, final Uri videoUri, final int totalThumbsCount, final long startPosition,
                                                   final long endPosition, final SingleCallback callback) {
